...
class OpenAIReportHelper:
    ...
    def generate_signal_and_micro_action(self, metrics: dict) -> tuple[str, str] | None:
        ...
        user_prompt = user_template.format(metrics_json=json.dumps(metrics, ensure_ascii=True))
